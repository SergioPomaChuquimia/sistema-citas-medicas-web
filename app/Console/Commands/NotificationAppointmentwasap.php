...
class NotificationAppointmentWasap extends Command
{
    ...
    public function handle()
    {
        ...
        foreach ($patients as $key => $patient) {
            $accessToken = 'EAAK5ZCV47yjUBOzY6PK1uDSmUtPJWZBPRAXBjC4ZBYnG6EOLrViKnjoiNFgnFP7YGBeYVIgQaQq3cA6HXnVVt4eZCPHHJUs86PemwMGUzhYe71gOT4Hl1TzREZC9qcNXSum0EnwwBdS6dD8F4JHR4lGiI9JZCkZAZBC1iCkNHZCtpxZCt9wLNXOTF4UCxZCohNDEMpWPXSze2BaJf41mvm0SfMZD';
         
            $fbApiUrl = 'https://graph.facebook.com/v17.0/369661302889518/messages';
