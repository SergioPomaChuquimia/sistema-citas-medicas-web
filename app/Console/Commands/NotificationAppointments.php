...
class NotificationAppointments extends Command
{
    ...
    public function handle()
    {
        ...
        $simulet_hour_number = date("2024-06-18 10:15:35");//strtotime(date("2023-10-24 09:35:35"));
        $appointments = Appointment::whereDate("date_appointment","2024-06-18")//now()->format("Y-m-d")
                                    ->where("status",1) 
                                    ->get();
